...
namespace ManolovPWS_v2.Modules.Identity.User.Auth.Authorization
{
    public interface IAuthorizationService
    {
        ...
        public Task<ITaskResult> GiveUserPermissionAsync(string userId, string permissionName, CancellationToken cancellationToken = default);
        public Task<ITaskResult> RevokeUserPermissionAsync(string userId, string permissionName, CancellationToken cancellationToken = default);
